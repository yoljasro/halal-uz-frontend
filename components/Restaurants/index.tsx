    ...
    <div className={styles.cont}>
      ...
      <div className={styles.cont__restaurants}>
        <div className={styles.cont__restaurants__restaurant}>
          <Image
            src="/assets/img/ergashMear.jpeg"
            alt="ergash meat"
            width={620}
            height={320}
          ...
          />
          <Image
            src={"/assets/img/ergashMeat1.png"}
        ...
        <div className={styles.cont__restaurants__restaurant}>
          <Image
            src="/assets/img/blackStarBurger.png"
            alt="meat"
            width={620}
            height={320}
            className={styles.cont__restaurants__restaurant__bg}
          />
          <Image
            src={"/assets/img/blackStarBurger1.png"}
            alt="ergash meat house"
            width={100}
            height={100}
            className={styles.cont__restaurants__restaurant__img}
