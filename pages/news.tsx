    ...
    <div className={styles.news}>
      ...
      <div className={styles.news__content}>
        ...
        >
          ...
          <div>
            ...
            <p className={styles.news__description}>
              B рамках Международной недели паломнического туризма 28 ноября текущего года в Бухарской области прошел Национальный гастрономический фестиваль, который привлек путешественников-мусульман из разных стран. Основная цель фестиваля - популяризация потенциала паломнического туризма Узбекистана, на международном уровне через халяльную еду.
            </p>
        ...
        >
          ...
          <div>
            <h3 className={styles.news__title}>
              B Турции пройдет Всемирный Халяльный Саммит 2023
            </h3>

            <p className={styles.news__description}>
              B Турции. Стамбуле c 25-28 ноября 2023 года.
            </p>
        ...
        >
          ...
          <div>
            <h3 className={styles.news__title}>
              B Ташкенте прошла встреча Президента Всемирного Халяльного Комитета WICS c Президнетом Всемирного Халяльного Саммита WHS
            </h3>
        ...
        >
          ...
          <div>
            ...
            <p className={styles.news__description}>
              C 12 по 14 мая на площади Дружбы народов  официальный фестиваль
              кофе и чая в Узбекистане.☕️ Основная цель фестиваля -
              Качественное развитие кофейной и чайной индустрии и бизнеса, a
