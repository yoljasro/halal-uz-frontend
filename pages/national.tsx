  ...
  return (
    <div className={styles.newsMain}>
      ...
      <div className={styles.newsMain__text}>
        ...
        В рамках Международной недели паломнического туризма 28 ноября текущего года в Бухарской области прошел Национальный гастрономический фестиваль, привлекший путешественников-мусульман из разных стран.
          <br /> <br />
        </p>
      </div>
    </div>
